...
// READ IN VARIABLES
tpw_civ_version = "1.52"; // Version string
...
tpw_civ_fnc_civspawn =
	...
	_civ addeventhandler ["animstatechanged",
		...
		if (_anim in ["AmovPknlMwlkSnonWnonDf","AmovPknlMrunSnonWnonDf"]) then 
			{
