...
tpw_mods_version = "20170304"; // will appear on start hint
...
tpw_core_fnc_disable = 
	...
	{_unit disableai _x} count ["move","anim","fsm","target","autotarget"];
...
tpw_core_fnc_enable = 
	...
	private ["_unit"];
	_unit = _this select 0;
	{_unit enableai _x} count ["move","anim","fsm","target","autotarget"];
